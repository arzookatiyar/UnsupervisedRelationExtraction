...
public class SimpleLDA implements Serializable {
	...
	public void addInstances (InstanceList training) {
		...
		for (Instance instance : training) {
			...
			//System.out.println(topicSequence.toString());
			...
			for (int position = 0; position < tokens.size(); position++) {
				...
				//System.out.println(typeTopicCounts.length+"\t"+tokens.size()+"\t"+type);
	...
	public static void main (String[] args) throws IOException {
		...
		//InstanceList training = InstanceList.load (new File("/Users/arzookatiyar/Desktop/TopicModeling/documents"));
