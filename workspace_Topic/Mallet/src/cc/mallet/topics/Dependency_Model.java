...
public class Dependency_Model implements Serializable{
	
	private static Logger logger = MalletLogger.getLogger(Dependency_Model.class.getName());
	...
	public Dependency_Model(int numberOfRelations) {
	...
	public Dependency_Model(int numberOfRelations, double alphaSum, double beta_lexical, double beta_path) {
	...
	public Dependency_Model(int numberOfRelations, double alphaSum, double beta_lexical, double beta_path, Randoms random) {
		this (newLabelAlphabet (numberOfRelations), alphaSum, beta_lexical, beta_path, random);
	}
	
	public Dependency_Model(LabelAlphabet relationAlphabet, double alphaSum, double beta_lexical, double beta_path, Randoms random) {
	...
	public String topWords(int numWords) {
		...
		for (int relation=0; relation < numRelations; relation++) {
			...
			output.append("pbox-replace\t");			
			for (int i=0; i < numWords; i++) {
				output.append(path_alphabet.lookupObject(sortedPaths[i].getID()) + ", ");
				//add the path part as well to the answer!
			}
	...
	public static void main (String[] args) throws IOException {
		...
		Dependency_Model lda = new Dependency_Model (numRelations, 10.0, 0.001, 0.01);
